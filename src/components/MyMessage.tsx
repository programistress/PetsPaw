  ...
  return (
    <div className='message__wrapper'>
      ...
      <p className='message_desc'>
        I'm sorry that this project isn't fully finished <span>YET.</span> I am and will be working on improving it, just didn't have enought time. <span>I am ready and motivated to work hard.</span>
      </p>
      <p className='message_desc'>
