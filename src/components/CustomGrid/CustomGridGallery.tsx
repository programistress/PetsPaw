...
import { getSavedLimit } from '../../features/cats/galleryPageSlice';
...
const CustomGridGallery = (props: BreedProps) => {


  // i need to display it by limit state
  const limit = useSelector(getSavedLimit)
  return (
    <div className='grid'>
      {/* 1 */}
      <div className='row'>
...
export default CustomGridGallery